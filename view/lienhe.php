      ...
      <section class="contact_area p_50">
            <div class="container">
                <div class="contact_title">
                    <p style="font-size: 20px;">Liên Hệ Với Chúng Tôi Để Được Giải Đáp Mọi Thắc Mắc</p>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <p>Tòa Nhà FPT, Đường Trịnh Văn Bô,<br />Nam Từ Liêm, Hà Nội.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="tel:+1109171234567">1900.636.099</a>
                                <a href="tel:+1101911897654">1900.636.789</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="mailto:busines@persuit.com"></a>nhom3duan1@gmail.com
                                <a href="mailto:support@persuit.com"></a>nhom3duan1@fpt.com.edu
                            </div>
                        </div>
                    </div>
                </div>
